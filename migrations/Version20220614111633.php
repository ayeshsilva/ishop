 ...
 */
final class Version20220614111633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD address VARCHAR(255) NOT NULL, ADD zipcode INT NOT NULL, ADD city VARCHAR(255) NOT NULL');
    }
